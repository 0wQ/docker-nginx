...
ENV NGINX_VERSION=1.15.9 OPENSSL_VERSION=1.1.1b
...
#     && git clone https://github.com/openssl/openssl . && git submodule update --init --recursive \
    ...
    && git clone https://github.com/eustas/ngx_brotli && cd ngx_brotli && git submodule update --init --recursive && cd .. \
